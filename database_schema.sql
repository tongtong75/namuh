...
-- 7. CKUP_GDS_MNG (from CkupGdsMngModel)
CREATE TABLE IF NOT EXISTS `CKUP_GDS_MNG` (
    `CKUP_GDS_SN` INT AUTO_INCREMENT PRIMARY KEY COMMENT '검진상품 일련번호',
...
-- 8. CKUP_GDS_ARTCL (from CkupGdsArtclModel)
CREATE TABLE IF NOT EXISTS `CKUP_GDS_ARTCL` (
    `CKUP_GDS_ARTCL_SN` INT AUTO_INCREMENT PRIMARY KEY COMMENT '검진상품항목 일련번호',
    `CKUP_GDS_SN` INT NULL COMMENT '검진상품 일련번호',
    `CKUP_ARTCL_SN` INT NULL COMMENT '검진항목 일련번호',
    `DEL_YN` CHAR(1) DEFAULT 'N' COMMENT '삭제여부'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 9. CKUP_GDS_CHC_GROUP (from CkupGdsChcGroupModel)
CREATE TABLE IF NOT EXISTS `CKUP_GDS_CHC_GROUP` (
    `CKUP_GDS_CHC_GROUP_SN` INT AUTO_INCREMENT PRIMARY KEY COMMENT '검진상품선택그룹 일련번호',
    `CKUP_GDS_SN` INT NULL COMMENT '검진상품 일련번호',
...
-- 10. CKUP_GDS_CHC_ARTCL (from CkupGdsChcArtclModel)
CREATE TABLE IF NOT EXISTS `CKUP_GDS_CHC_ARTCL` (
    `CKUP_GDS_CHC_ARTCL_SN` INT AUTO_INCREMENT PRIMARY KEY COMMENT '검진상품선택항목 일련번호',
    `CKUP_GDS_CHC_GROUP_SN` INT NULL COMMENT '검진상품선택그룹 일련번호',
    `CHC_ARTCL_SN` INT NULL COMMENT '선택항목 일련번호',
    `DEL_YN` CHAR(1) DEFAULT 'N' COMMENT '삭제여부'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 11. CKUP_GDS_ADD_CHC (from CkupGdsAddChcModel)
CREATE TABLE IF NOT EXISTS `CKUP_GDS_ADD_CHC` (
    `CKUP_GDS_ADD_CHC_SN` INT AUTO_INCREMENT PRIMARY KEY COMMENT '검진상품추가선택 일련번호',
    `CKUP_GDS_SN` INT NULL COMMENT '검진상품 일련번호',
    `CHC_ARTCL_SN` INT NULL COMMENT '선택항목 일련번호',
    `DEL_YN` CHAR(1) DEFAULT 'N' COMMENT '삭제여부'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- 15. RSVN_CKUP_GDS 
CREATE TABLE IF NOT EXISTS `RSVN_CKUP_GDS` (
  `RSVN_CKUP_GDS_SN` int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY COMMENT '예약검진상품 일련번호',
  `CKUP_GDS_SN` int(11) DEFAULT NULL COMMENT '검진상품 일련번호',
  ...
  `REG_YMD` datetime DEFAULT NULL COMMENT '등록일시',
  `MDFCN_YMD` datetime DEFAULT NULL COMMENT '수정일시'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='예약검진상품';

-- 16. RSVN_CKUP_GDS_ADD_CHC 
CREATE TABLE IF NOT EXISTS `RSVN_CKUP_GDS_ADD_CHC` (
  ...
  `CKUP_GDS_ADD_ARTCL_SN` int(11) DEFAULT NULL COMMENT '검진상품선택항목 일련번호',
  `CKUP_TRGT_SN` int(11) DEFAULT NULL COMMENT '검진대상 일련번호',
  `REG_ID` varchar(50) DEFAULT NULL COMMENT '등록자 ID',
  `MDFCN_ID` varchar(50) DEFAULT NULL COMMENT '수정자 ID',
  `DEL_YN` char(1) DEFAULT 'N' COMMENT '삭제여부',
...
CREATE TABLE IF NOT EXISTS `RSVN_CKUP_GDS_CHC_ARTCL` (
  ...
  `CKUP_GDS_CHC_ARTCL_SN` int(11) DEFAULT NULL COMMENT '검진상품선택항목 일련번호',
  `CKUP_TRGT_SN` int(11) DEFAULT NULL COMMENT '검진대상 일련번호',
  `REG_ID` varchar(50) DEFAULT NULL COMMENT '등록자 ID',
  `MDFCN_ID` varchar(50) DEFAULT NULL COMMENT '수정자 ID',
  `DEL_YN` char(1) DEFAULT 'N' COMMENT '삭제여부',
