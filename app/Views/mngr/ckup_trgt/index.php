...
<head>
    ...
    <?php echo view('partials/title-meta', array('title'=>'검진대상자관리')); ?>
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    <?= view('partials/page-title', ['pagetitle' => '검진관리', 'title' => '검진대상자 목록']) ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                     <!--div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <div>
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" id="create-item-btn" data-bs-target="#mainModal">
                                                <i class="ri-add-line align-bottom me-1"></i> 신규 대상자 등록
                                            </button>
                                            <span id="datatables-buttons-placeholder"></span>
                                        </div>
                                    </div-->
