...
<head>
    <?php echo view('partials/title-meta', array('title' => '검진상품 관리')); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <!-- 검색 필터 영역 -->
                                <div class="card-header" style="background-color:aliceblue"><!--#d3e3fd-->
                                    ...
                                    <form id="filter-form" class="filter-form" onsubmit="return false;">
                                        <div class="row gx-2 gy-2 align-items-end">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <select id="co_sn_filter" name="co_sn_filter" class="form-select">
                                                    ...
                                                    <?php foreach ($companies as $company): ?>
                                                        <option value="<?= esc($company['CO_SN']) ?>">
                                                            <?= esc($company['CO_NM']) ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                            ...
                                            <div class="col d-flex justify-content-end gap-2">
                                                <a href="<?= base_url('mngr/ckupGdsMng/add') ?>" class="btn btn-outline-primary">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            const mngrTable = $('#mngrListTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: BASE_URL + 'mngr/ckupGdsMng/ajax_list',
                    type: 'POST',
                    data: function(d) {
                        // CSRF 토큰 및 필터 데이터 추가
                ...
                searching: false, // 기본 검색 비활성화 (커스텀 필터 사용)
                responsive: true,
                lengthChange: false,
                pageLength: 10
            });
            ...
            // 삭제 버튼 이벤트 (동적으로 생성되는 요소에 대한 이벤트 위임)
        ...
        function deleteCheckupProduct(id) {
            $.ajax({
                url: BASE_URL + 'mngr/ckupGdsMng/delete/' + id,
                type: 'POST',
                data: {
