                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <label for="SPRT_SE_input" class="form-label">지원구분</label>
                                                    <input type="text" id="SPRT_SE_input" name="SPRT_SE" class="form-control" placeholder="지원구분 입력" maxlength="2" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                </div>
                                                <div class="col-md-2 mb-3">
                                                    <label for="FAM_SPRT_SE_input" class="form-label">가족지원구분</label>
                                                    <input type="text" id="FAM_SPRT_SE_input" name="FAM_SPRT_SE" class="form-control" placeholder="가족지원구분 입력" maxlength="2" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                                </div>
                                            </div>
                                        </div><!-- //card-body -->
                                    </div><!-- //card -->
    ...
    const CkupGdsManager = {
        ...
        populateFormForEditMode: function() {
            ...
            if (data.basicInfo) {
                ...
                $('#SPRT_SE_input').val(data.basicInfo.SPRT_SE);
                $('#FAM_SPRT_SE_input').val(data.basicInfo.FAM_SPRT_SE);
            }
        ...
        saveAllData: function() {
            ...
            const basicInfo = {
                ...
                SPRT_SE: $('#SPRT_SE_input').val().trim(),
                FAM_SPRT_SE: $('#FAM_SPRT_SE_input').val().trim()
            };
            ...
            $('.choice-item-group').each(function() {
                ...
                const choiceItems = $(`#ckupGdsChcArtclTable${groupIndex}`).DataTable().rows().data().toArray().map(item => item.CKUP_ARTCL_SN);
            ...
            const addChoiceItems = this.state.tables.addChcArtclTable.rows().data().toArray().map(item => item.CKUP_ARTCL_SN);
